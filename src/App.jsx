...
function App() {
  return (
    <div className="research-report">
      <div className="research-report-section report-header">
        <h1 className="main-title">탄수화물과 혈당 스파이크: 연령과 성별에 따른 차이</h1>
      </div>
      ...
      <div className="research-report-section">
        <h2 className="section-title">연령에 따른 혈당 반응 차이</h2>
        <p className="section-description">
      ...
      <div className="research-report-section">
        <h2 className="section-title">연령 및 성별에 따른 탄수화물 필요량</h2>
        <p className="section-description">
      ...
      <div className="research-report-section">
        <h2 className="section-title">어린이(3~5세)의 탄수화물 섭취 특성</h2>
        <p className="section-description">어린이는 성인과 다른 영양적 요구사항을 가지고 있습니다:</p>
        <ul className="recommendation-list">
          <li>성장과 발달을 위한 에너지원으로 적절한 탄수화물 섭취가 중요합니다.</li>
          <li>어린이의 신체는 탄수화물을 성장 에너지로 효율적으로, 우선적으로 활용합니다.</li>
          <li>균형 잡힌 식사가 가장 중요하며, 과일, 채소, 전체곡물을 포함한 다양한 식품을 섭취해야 합니다.</li>
          <li>단순당(과자, 청량음료 등)의 과도한 섭취는 제한하는 것이 좋습니다.</li>
          <li>극단적인 식이제한은 성장 발달에 부정적 영향을 줄 수 있습니다.</li>
        </ul>
      ...
      <div className="research-report-section">
        <h2 className="section-title">성인여성(40~45세)의 탄수화물 섭취 특성</h2>
        <p className="section-description">40~45세 여성의 대사적 특성과 탄수화물 섭취 고려사항:</p>
        <ul className="recommendation-list">
          <li>호르몬 변화로 인해 인슐린 감수성이 달라질 수 있어 탄수화물 대사에 영향을 미칩니다.</li>
          <li>폐경 전후 체중 증가와 지방 분포 변화가 혈당 조절에 영향을 줄 수 있습니다.</li>
          <li>정제된 탄수화물보다 전체곡물, 식이섬유가 풍부한 음식이 혈당 안정에 도움이 됩니다.</li>
          <li>총 에너지의 45-65%를 탄수화물로 섭취하는 것이 권장됩니다.</li>
          <li>개인의 활동량, 건강상태에 따라 탄수화물 필요량을 조절할 필요가 있습니다.</li>
        </ul>
        <p className="whitespace-pre-wrap break-words">
      ...
      <div className="research-report-section">
        <h2 className="section-title">다양한 식품의 글리세믹 지수(GI) 비교</h2>
        <p className="section-description">
      ...
      <div className="research-report-section">
        <h2 className="section-title">실용적인 권장사항</h2>
        
        <h3 className="subsection-title">어린이(3~5세)를 위한 권장사항</h3>
        <ul className="recommendation-list">
          <li>균형 잡힌 식사로 다양한 영양소를 공급하세요.</li>
          <li>단순당(과자, 음료수)의 과다 섭취를 제한하세요.</li>
          <li>연령에 맞는 적절한 양의 탄수화물을 제공하세요.</li>
          <li>소화기능을 고려해 잡곡과 백미의 적절한 조합을 활용하세요.</li>
          <li>극단적인 식단 제한은 피하세요.</li>
        </ul>

        <h3 className="subsection-title">성인여성(40~45세)을 위한 권장사항</h3>
        <ul className="recommendation-list">
          <li>정제된 탄수화물보다 전체곡물을 선택하세요.</li>
          <li>탄수화물과 함께, 단백질, 건강한 지방을 균형있게 섭취하세요.</li>
          <li>채소-단백질-탄수화물 순서로 식사하세요.</li>
          <li>개인의 신체 활동과 건강 상태에 맞게 탄수화물 섭취를 조절하세요.</li>
          <li>
